...
Having a dedicated SWG to standardise approaches, working in conjunction with other WGs such as the OGC API "umbrella" SWG, the OAB and the Spatial Data on the Web WG will allow for solutions to be validated and shared to cover the spectrum of terminology and terminology services approaches.
