...
Profiles of existing OGC standards will be described as Building Blocks supporting further profiling and combinations using the same mechanisms as profile constraint specifications (i.e., a scalable, reusable solution)
