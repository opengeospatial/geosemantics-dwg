...
http://ogc.standardstracker.org/show_request.cgi?id=631
...
http://ogc.standardstracker.org/show_request.cgi?id=633
...
http://ogc.standardstracker.org/show_request.cgi?id=634
...
==== Extension 17: Allow multiple modeling levels for connection patterns between objects and geometry descriptions

===== Standards Tracker Change Request URI

http://ogc.standardstracker.org/show_request.cgi?id=635
...
http://ogc.standardstracker.org/show_request.cgi?id=638
...
http://ogc.standardstracker.org/show_request.cgi?id=640
